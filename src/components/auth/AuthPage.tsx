...
export const AuthPage: React.FC<AuthPageProps> = ({ onAuthenticate }) => {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (loginRole === 'STAFF') {
      onAuthenticate(
        {
          ...mockUsers[0],
          email: username || mockUsers[0].email,
        },
        'STAFF'
      );
    } else {
      onAuthenticate(
        {
          ...mockUsers[1],
          email: username || mockUsers[1].email,
        },
        'STUDENT'
      );
    }
  ...
  // Form submission: Student Signup
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <form onSubmit={handleLoginSubmit} className="space-y-3.5">
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
                    type="submit"
                    className="w-full py-2.5 rounded-lg font-bold text-xs sm:text-sm bg-[#26a69a] hover:bg-[#00897b] text-white shadow-xs transition-all text-center flex items-center justify-center gap-1.5 active:scale-95"
                  >
                    <span>Login</span>
              ...
              <div>
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-lg bg-white border border-[#d4cbbe] hover:bg-slate-50 text-slate-700 font-semibold text-xs sm:text-sm flex items-center justify-center gap-2.5 transition-all shadow-xs"
                >
